...
# Solution based on limiting matrix of Markov Chains: e.g. https://www.youtube.com/watch?v=qhnFHnLkrfA

# Using linear alegbra classes from http://code.activestate.com/recipes/189971-basic-linear-algebra-matrix/
...
class Matrix:
	...
	def __init__(self, *args):
		...
		null square matrix of that size.

		2. Two integer arguments are supplied.  The constructor creates a null
		matrix of size first argument x second argument.

		3. A list of lists is supplied.
		"""
